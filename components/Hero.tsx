...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: "900px", width: "100%", position: "relative", zIndex: 1, paddingTop: "80px" }}>
        {/* Status badge */}
        <div
        ...
        >
          ...
          <span style={{ fontFamily: "var(--font-mono)", fontSize: "0.72rem", color: "var(--accent)", letterSpacing: "0.05em" }}>
            Available for work
          </span>
        </div>
        ...
        <div
          ...
          style={{ marginBottom: "1.5rem", minHeight: "3rem", display: "flex", alignItems: "center" }}
        >
          <span style={{
            fontFamily: "var(--font-display)",
        ...
        >
          Lulusan S1 Sistem Informasi dengan{" "}
          <span style={{ color: "var(--text-primary)", fontWeight: 500 }}>5 tahun pengalaman</span>{" "}
          membangun aplikasi mobile & web yang scalable. Fokus di React Native,
          Next.js, dan Node.js — dari pixel pertama sampai server production.
        </p>
        ...
        >
          {[
            ...
            { icon: <Link size={18} />, href: "https://linkedin.com", label: "LinkedIn" },
            { icon: <Mail size={18} />, href: "mailto:eldirb04@email.com", label: "Email" },
          ].map((s) => (
            <a
              key={s.label}
              href={s.href}
